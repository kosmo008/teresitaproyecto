 ...
 * @author kosmo
 */
public class Lec4 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Lec4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
