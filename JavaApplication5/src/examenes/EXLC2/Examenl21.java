 ...
 * @author kosmo
 */
public class Examenl21 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Examenl21.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
