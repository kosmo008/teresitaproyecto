 ...
 * @author kosmo
 */
public class Lec1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnRE.setText("Realizar Evaluacion");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        pantalla_bienvenida obgj=new pantalla_bienvenida();
        obgj.show();
        this.show(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Lec1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
